        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={6} lg={4} className="project-card">
            <ProjectCard
              ...
              description = "Fitness Tracker is a project aimed to simplify the Fitness Aspects of an individual's health using simplified features    such as weight tracking, calories tracking. This is a fully functional Project website that uses React.js +  HTML and CSS in the frontend and SpringBoot, Dot.Net MVC in backend and MySQL as Database."
              ghLink = "https://github.com/pratikkhadse04"
